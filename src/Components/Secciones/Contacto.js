              ...
              {/*  <div className="col-md-6 col-lg-7 my-3 wow fadeInUp">
                                <div className="card-page">
                                    <div className="maps-container">
                                        <div id="myMap">
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.5909100780646!2d-104.67661758448833!3d24.010218984461993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x869b68dd1de21f35%3A0x4db9768746b3fa8c!2sEscuela%20Secundaria%20T%C3%A9cnica%20N%C2%BA%2019%20Ing.%20Manuel%20Francisco%20Peyro%20Carre%C3%B1o!5e0!3m2!1ses!2smx!4v1622819264897!5m2!1ses!2smx" width="600" height="450" style={{ border: 0 }} allowfullscreen="" loading="lazy" title="ubicacion de la escuela"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div> */}

              <div class="bg-white contact4 overflow-hiddedn position-relative">
                <div class="row no-gutters">
                  <div class="container">
                    <div class="col-lg-6 contact-box mb-4 mb-md-0">
                      <div class="">
                        <h1 class="title font-weight-light text-dark mt-2">¡Contáctanos!</h1>
                        <form class="mt-3">
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group mt-2">
                                <input class="form-control text-dark" type="text" placeholder="Nombre" required/>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group mt-2">
                                <input class="form-control text-dark" type="tel" placeholder="Teléfono" required/>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group mt-2">
                                <input class="form-control text-dark" type="email" placeholder="Correo Electrónico" required/>
                              </div>
                            </div>
                            <div class="col-lg-12">
                              <div class="form-group mt-2">
                                <input class="form-control text-dark" type="text" placeholder="Asunto" required/>
                              </div>
                            </div>
                            <div class="col-lg-12">
                              <div class="form-group mt-2">
                                <textarea class="form-control text-dark" rows="3" placeholder="Mensaje" required></textarea>
                              </div>
                            </div>
                            <div class="col-lg-12 d-flex align-items-center mt-2">
                              <button type="submit" class="btn bg-success text-inverse px-3 py-2"><span> Enviar</span></button>
                            </div>
                          </div>
                        </form>
                      </div>
                  ...
                  <div class="col-lg-6 right-image p-r-0">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.5909100780646!2d-104.67661758448833!3d24.010218984461993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x869b68dd1de21f35%3A0x4db9768746b3fa8c!2sEscuela%20Secundaria%20T%C3%A9cnica%20N%C2%BA%2019%20Ing.%20Manuel%20Francisco%20Peyro%20Carre%C3%B1o!5e0!3m2!1ses!2smx!4v1622819264897!5m2!1ses!2smx"
                      width="100%" height="538" frameborder="0" style={{ border: 0 }} allowfullscreen data-aos="fade-left" data-aos-duration="3000" title="ubicacion de la escuela"></iframe>
                  </div>
                </div>
              </div>
